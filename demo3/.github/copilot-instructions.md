...
- **EEZ Studio Project**: `demo3.eez-project` contains the visual UI design and build configuration
...
❌ **Don't use PlatformIO CLI commands** - PlatformIO CLI (`pio`) is not installed on this system

## Build Environment Requirements

⚠️ **IMPORTANT**: This project requires VS Code with the PlatformIO IDE extension for building and uploading:
- **PlatformIO CLI**: NOT available - `pio` commands will fail
- **Build Method**: Use VS Code PlatformIO IDE extension only
- **Build Commands**: Use VS Code Command Palette → "PlatformIO: Build" or toolbar buttons
- **Upload Commands**: Use VS Code Command Palette → "PlatformIO: Upload" or toolbar buttons
- **Monitor**: Use VS Code PlatformIO Serial Monitor (not `pio device monitor`)

## Development Workflow

### Making UI Changes
1. Open `demo3.eez-project` in EEZ Studio
...
- **Build Method**: VS Code PlatformIO IDE extension only (CLI not available)
- **Build Actions**: Use VS Code Command Palette or PlatformIO toolbar
  - Build: "PlatformIO: Build" or Build button in toolbar
  - Upload: "PlatformIO: Upload" or Upload button in toolbar
  - Clean: "PlatformIO: Clean" or Clean button in toolbar
...
```
demo3.eez-project          # EEZ Studio project file (edit in studio)
...
- Use PlatformIO Serial Monitor in VS Code (not CLI commands)
